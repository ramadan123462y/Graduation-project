<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ url('dashboard/article-subcategorie/store') }}"
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" required name="articlecategorie_id"
                    ...
                    <div class="input-group">
                        ...
                        <textarea class="form-control"  name="descreption" aria-label="With textarea"></textarea>
                      </div>
